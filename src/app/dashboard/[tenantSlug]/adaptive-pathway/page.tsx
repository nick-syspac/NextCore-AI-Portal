              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-purple-100 to-indigo-100 rounded-lg p-6 border border-purple-300">
                  ...
                  <p className="text-sm text-gray-700">
                    Our hybrid algorithm combines collaborative filtering with content embeddings to recommend
                    optimal learning pathways based on similar students and your interests.
                  </p>
                </div>
            ...
            {activeTab === 'pathway' && (
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-indigo-100 to-blue-100 rounded-lg p-6 border border-indigo-300">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">📊 Your Recommended Pathways</h3>
                  <p className="text-sm text-gray-700">
                    Top 5 learning pathways personalized for you using collaborative filtering and content similarity.
                  </p>
                </div>
                ...
                {recommendations.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-4">No Recommendations Yet</h3>
                  ...
                  <div className="space-y-4">
                    {recommendations.map((rec, index) => (
                      <div key={rec.id} className="bg-white rounded-lg border-2 border-purple-200 p-6 hover:shadow-lg transition-shadow">
                        <div className="flex items-start justify-between mb-4">
                          <div className="flex-1">
                            <div className="flex items-center gap-3 mb-2">
                              <span className="text-2xl font-bold text-purple-600">#{index + 1}</span>
                              <h4 className="text-xl font-bold text-gray-900">{rec.pathway_name}</h4>
                            </div>
                        ...
                        <div className="grid grid-cols-3 gap-4 mb-4">
                          ...
                          <div className="bg-blue-50 rounded-lg p-3 text-center">
                            ...
                            <p className="text-lg font-bold text-blue-600">{rec.similar_students_count}</p>
                          </div>
                        </div>

                        <div className="bg-gray-50 rounded-lg p-4">
                          <p className="text-sm font-semibold text-gray-700 mb-2">💡 Why This Pathway?</p>
            ...
            {activeTab === 'progress' && (
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-blue-100 to-cyan-100 rounded-lg p-6 border border-blue-300">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">⏱️ Track Your Progress</h3>
                  <p className="text-sm text-gray-700">
                    Monitor engagement metrics, time spent, and adaptive recommendations for your learning journey.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                  ...
                  <div className="space-y-4">
                    {[
                      { title: 'Introduction to Python', type: 'video', status: 'completed', score: 95, time: 45 },
                      { title: 'Python Data Structures', type: 'reading', status: 'in_progress', score: null, time: 23 },
                      { title: 'Functions and Modules', type: 'quiz', status: 'not_started', score: null, time: 0 },
                      { title: 'OOP Concepts', type: 'assignment', status: 'not_started', score: null, time: 0 }
                    ].map((step, index) => (
                      <div key={index} className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-3 mt-1">
                            <span className={`px-2 py-1 rounded text-xs font-semibold ${getStatusColor(step.status)}`}>
                              {step.status.replace('_', ' ').toUpperCase()}
                            </span>
                            <span className="text-sm text-gray-600">⏱️ {step.time} min</span>
                            {step.score && (
                              <span className="text-sm font-semibold text-green-600">✓ {step.score}%</span>
                            )}
                          </div>
                        </div>
                      </div>
            ...
            {activeTab === 'analytics' && (
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-green-100 to-emerald-100 rounded-lg p-6 border border-green-300">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">📈 Completion Rate Analytics</h3>
                  <p className="text-sm text-gray-700">
                    Higher course completion rates achieved through personalized pathway recommendations.
                  </p>
                </div>
                      ...
                      {[
                        ...
                        <div key={item.level}>
                          <div className="flex justify-between text-sm mb-1">
                            ...
                            <span className="text-gray-600">{item.rate}% ({item.count} pathways)</span>
                          </div>
            ...
            {activeTab === 'algorithm' && (
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-indigo-100 to-purple-100 rounded-lg p-6 border border-indigo-300">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">🧠 Hybrid Recommendation Algorithm</h3>
                  <p className="text-sm text-gray-700">
                    Combining collaborative filtering with content embeddings for optimal pathway recommendations.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-white rounded-lg border-2 border-purple-300 p-6">
                    ...
                    <p className="text-sm text-gray-700 mb-4">
                      Find students with similar learning patterns using Jaccard similarity on completed steps.
                    </p>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                  ...
                  <div className="space-y-3">
                    {[
                      { step: 1, title: 'Find Similar Students', desc: 'Jaccard similarity on completed steps', color: 'purple' },
                      { step: 2, title: 'Get Candidate Pathways', desc: 'Pathways from similar students (same skill level)', color: 'blue' },
                      { step: 3, title: 'Calculate CF Score', desc: 'Popularity + completion rate among similar students', color: 'indigo' },
                      { step: 4, title: 'Calculate Embedding Score', desc: 'Content similarity with student interests', color: 'violet' },
                      { step: 5, title: 'Hybrid Score', desc: '(0.6 × CF) + (0.4 × Embeddings)', color: 'purple' },
                      { step: 6, title: 'Return Top 5', desc: 'Ranked by hybrid score with reasons', color: 'pink' }
                    ].map((item) => (
                      <div key={item.step} className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
                        <div className={`w-8 h-8 rounded-full bg-${item.color}-600 text-white font-bold flex items-center justify-center flex-shrink-0`}>
                          {item.step}
                        </div>
                        <div className="flex-1">
                ...
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-6 border border-purple-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <p className="text-sm font-medium text-gray-700 mb-2">📊 Personalization Factors</p>
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-700 mb-2">🎯 Continuous Improvement</p>
                      <ul className="text-sm text-gray-600 space-y-1">
